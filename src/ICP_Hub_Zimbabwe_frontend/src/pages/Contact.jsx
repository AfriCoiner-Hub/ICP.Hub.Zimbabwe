      ...
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col items-center md:flex-row">
          ...
          <div className="w-full space-y-5 md:w-3/5 md:pr-16">
            <p className="text-blue-500 text-3xl font-bold uppercase">Contact Us</p>
            <h2 className="text-2xl font-extrabold leading-none text-black dark:text-white sm:text-3xl md:text-5xl">
              Get In Touch With Us.
            </h2>
            <p className="text-2xl text-slate-600 dark:text-slate-200 md:pr-16">We would love to hear from you! Whether you have a question about features, pricing, need a demo, or anything else, our team is ready to answer all your questions.</p>
          </div>
