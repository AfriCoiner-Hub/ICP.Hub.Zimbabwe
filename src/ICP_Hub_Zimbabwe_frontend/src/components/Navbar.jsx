...
function Navbar() {
    return (
        <nav className="h-36 sticky bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%">
            <div className="container mx-auto flex items-center justify-between h-full">
                ...
                <div className="flex space-x-10 font-mono md:text-3xl">
                    ...
                    <a href="/projects" className="py-4 px-14 hover:font-bold hover:text-gray-900 transition hover:bg-gradient-to-r from-teal-400 to-blue-500">Services</a>
